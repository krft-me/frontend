...
import { ApplicationUserBadgeFormService, ApplicationUserBadgeFormGroup } from './application-user-badge-form.service';
...
export class ApplicationUserBadgeUpdateComponent implements OnInit {
  ...
  protected updateForm(applicationUserBadge: IApplicationUserBadge): void {
    ...
    this.applicationUsersSharedCollection = this.applicationUserService.addApplicationUserToCollectionIfMissing<IApplicationUser>(
      ...
      applicationUserBadge.applicationUser
    );
      ...
      .pipe(
        map((applicationUsers: IApplicationUser[]) =>
          this.applicationUserService.addApplicationUserToCollectionIfMissing<IApplicationUser>(
            applicationUsers,
            this.applicationUserBadge?.applicationUser
          )
        )
      )
