...
type RestOf<T extends IApplicationUserBadge | NewApplicationUserBadge> = Omit<T, 'obtentionDate'> & {
...
export class ApplicationUserBadgeService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/application-user-badges');
  ...
  protected convertDateFromClient<T extends IApplicationUserBadge | NewApplicationUserBadge | PartialUpdateApplicationUserBadge>(
    ...
    return {
      ...
      obtentionDate: applicationUserBadge.obtentionDate?.toJSON() ?? null,
    };
  }
  ...
  protected convertDateFromServer(restApplicationUserBadge: RestApplicationUserBadge): IApplicationUserBadge {
    return {
      ...
      obtentionDate: restApplicationUserBadge.obtentionDate ? dayjs(restApplicationUserBadge.obtentionDate) : undefined,
    };
  }
