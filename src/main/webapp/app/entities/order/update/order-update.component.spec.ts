...
describe('Order Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call ApplicationUserOffer query and add missing value', () => {
      ...
      const provider: IApplicationUserOffer = { id: 44088 };
      ...
      const additionalApplicationUserOffers = [provider];
    ...
    it('Should update editForm', () => {
      const order: IOrder = { id: 456 };
      const provider: IApplicationUserOffer = { id: 62962 };
      order.provider = provider;
      const client: IApplicationUser = { id: 56981 };
      order.client = client;

      activatedRoute.data = of({ order });
      comp.ngOnInit();

      expect(comp.applicationUserOffersSharedCollection).toContain(provider);
      expect(comp.applicationUsersSharedCollection).toContain(client);
