...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("me.krft.frontend.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("me.krft.frontend.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
